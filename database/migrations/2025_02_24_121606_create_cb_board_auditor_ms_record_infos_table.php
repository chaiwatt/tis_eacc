...
class CreateCbBoardAuditorMsRecordInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cb_board_auditor_ms_record_infos', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('board_auditor_id')
                ->references('id')->on('app_certi_cb_auditors')
    ...
    {
        Schema::dropIfExists('cb_board_auditor_ms_record_infos');
    }
}
