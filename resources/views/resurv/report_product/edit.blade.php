            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form id="form_data" method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table color-bordered-table primary-bordered-table" id="myTable">
                                        ...
                                        @foreach($data_map_table as $list)
                                            <tr>
                                                ...
                                                <td style="font-size: 14px; vertical-align: text-top;">
                                                <?php
                                                    $data_detail = DB::table( 'save_example_file' )->where('example_id_no', $list->id)->first();
                                                ?>
                                                    <div class="custom-file">
                                                        ...
                                                        <span>{{$data_detail ? $data_detail->file: ''}}</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php
                        ...
                        <div align="right">
                            <button class="btn btn-success btn-sm waves-effect waves-light" id="save" type="submit"
                                    onclick="check_submit2();"><b>บันทึก</b></button>
                            <button class="btn btn-info btn-sm waves-effect waves-light" id="send" type="submit"
                                    onclick="check_submit();"><i class="fa fa-send"></i><b>ส่ง</b></button>
            ...
            <script type="text/javascript">
                ...
                function add_file_upload() {
                    ...
                    var html_add_item = '<div class="form-group sub_file">\n' +
                        ...
                        '<div class="col-md-4">\n' +
                        '<input type="file" accept="application/pdf" id="file' + next_num + '" name="file' + next_num + '" class="form-control">\n' +
                        '</div>\n' +
                ...
                $(document).on('click', '.remove_old', function () {
                    ...
                    $('.file_old').remove();
                    $('#file_old0').remove();
                    $('#new_file').html('<input type="file" class="form-control sub_file" accept="application/pdf" id="file" name="file' + next_num + '"><input name="num_row_file[]" hidden>')
                });
