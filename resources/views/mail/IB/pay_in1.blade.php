...
<body>
    ...
    <div id="style"> 
        ...
        <p class="indent50"> 
            ตามที่ สำนักงานมาตรฐานผลิตภัณฑ์อุตสาหกรรม ได้แนบหลักฐานการชำระเงินค่าบริการในการตรวจประเมิน คำขอรับบริการหน่วยตรวจ
            เมื่อวันที่  {{  !empty($pay_in->start_date) ?  HP::formatDateThaiFull($pay_in->start_date) :  ''  }}    
            หมายเลขคำขอ    {{  !empty($certi_ib->app_no) ?   $certi_ib->app_no  :  ''  }} 
