...
<body>
   <div id="style">
    ...
    <p class="indent50">   
        ...
        ของ   {{  !empty($certi_ib->name) ?  $certi_ib->name :  ''  }} 
     ...
     <p><b>หลักฐาน :</b>   </p>  
      ...
      <p><b>หลักฐาน :</b>   </p>  
             ...
             <p class="indent50"> 
                 ...
                 {{  @$item->file_desc_text  }}
                 <a href="{{url('certify/check/file_ib_client/'.$item->attach_files.'/'.( !empty($item->file_client_name) ? $item->file_client_name :  basename($item->attach_files)  ))}}" target="_blank">
