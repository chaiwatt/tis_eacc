   ...
   <div id="style">
        ...
        <p> 
         ...
         <p class="indent50"> 
            ...
            ของคำขอเลขที่    {{  !empty($certi_cb->app_no) ?   $certi_cb->app_no  :  ''  }} 
             {{  !empty($certi_cb->name) ? $certi_cb->name   :  ''  }}
            ได้ดำเนินการชำระเรียบร้อยแล้ว 
        </p>
        {{-- <p class="indent50"> 
            ค่าธรรมเนียมคำขอ และค่าธรรมเนียมใบรับรอง
        </p>
         @if(!is_null($PayIn->FileAttachPayInTwo3To))
            <p class="indent50"> 
                <a href="{{ url('certify/check/files_cb/'.$PayIn->FileAttachPayInTwo3To->file) }}"> 
         ...
         @if(!is_null($PayIn->FileAttachPayInTwo4To))
            <p class="indent50"> 
                <a href="{{ url('certify/check/files_cb/'.$PayIn->FileAttachPayInTwo4To->file) }}"> 
