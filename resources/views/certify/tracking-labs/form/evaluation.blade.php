...
@if(count($evaluation->history_labs_many) > 0)               
<div class="row">
    <div class="col-md-12">
...
<div id="collapse" class="panel-collapse collapse ">
    <br>
 <div class="container-fluid">
@foreach($evaluation->history_labs_many as $key1 => $item)
...
@if(count($evaluation->log_tracking_assessment_bug_many) > 0) 
<div class="row">
    <div class="col-md-12">
        <div class="white-box" style="border: 2px solid #e5ebec;">
...
<div class="row">
 ...
 <div id="evaluation" class="panel-collapse collapse  in">
    <br> 
@foreach($evaluation->log_tracking_assessment_bug_many as $key1 => $item1)
...
<div class="row form-group">
    <div class="col-md-12">
        <div class=" {{ $errors->has('name') ? 'has-error' : ''}}">
            {!! HTML::decode(Form::label('name','ชื่อห้องปฏิบัติการ'.' :', ['class' => 'col-md-3 control-label text-right'])) !!}
            <div class="col-md-7">
...
@endif
 ...
 {{-- {!! Form::open(['url' => 'certify/tracking-labs/evaluation/update/'.$evaluation->id,
