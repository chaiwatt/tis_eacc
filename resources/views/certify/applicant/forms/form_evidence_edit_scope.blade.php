                ...
                @foreach ( $file_sectionn4 as $section4 )
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{!! HP::getFileStorage($attach_path.$section4->file) !!}" target="_blank" class="view-attach btn btn-sm">{!! HP::FileExtension($section4->file_client_name)  ?? '' !!} {!! $section4->file_client_name  ?? '' !!}</a>
...
<fieldset class="white-box">
    ...
    <legend><h4><span class="text-danger">*</span> 5. ขอบข่ายที่ยื่นขอรับการรับรอง
        (<span class="text-warning">ห้องปฏิบัติการสอบเทียบ</span>) (Scope of Accreditation Sought (<span class="text-warning">For calibration laboratory</span>)) </h4></legend>
            ...
            @elseif($urlType == 'show' && ($labTestRequest->count() !== 0 ||  $labCalRequest->count() !== 0) )
                ...
                @foreach ( $file_sectionn5 as $section5 )
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{!! HP::getFileStorage($attach_path.$section5->file) !!}" target="_blank" class="view-attach btn btn-sm">{!! HP::FileExtension($section5->file)  ?? '' !!} {!! $section5->file_client_name  ?? '' !!}</a>
                    ...
                    @foreach ( $file_sectionn72 as $section72 )
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{!! HP::getFileStorage($attach_path.$section72->file) !!}" target="_blank" class="view-attach btn btn-sm">{!! HP::FileExtension($section72->file)  ?? '' !!} {!! $section72->file_client_name  ?? '' !!}</a>
                    ...
                    @foreach ( $file_sectionn71 as $section71 )
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{!! HP::getFileStorage($attach_path.$section71->file) !!}" target="_blank" class="view-attach btn btn-sm">{!! HP::FileExtension($section71->file)  ?? '' !!} {!! $section71->file_client_name  ?? '' !!}</a>
                ...
                @foreach ( $file_sectionn8 as $section8 )
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{!! HP::getFileStorage($attach_path.$section8->file) !!}" target="_blank" class="view-attach btn btn-sm">{!! HP::FileExtension($section8->file)  ?? '' !!} {!! $section8->file_client_name  ?? '' !!}</a>
                ...
                @foreach ( $file_sectionn9 as $section9 )
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{!! HP::getFileStorage($attach_path.$section9->file) !!}" target="_blank" class="view-attach btn btn-sm">{!! HP::FileExtension($section9->file)  ?? '' !!} {!! $section9->file_client_name  ?? '' !!}</a>
                ...
                @foreach ( $file_sectionn10 as $section10 )
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{!! HP::getFileStorage($attach_path.$section10->file) !!}" target="_blank" class="view-attach btn btn-sm">{!! HP::FileExtension($section10->file)  ?? '' !!}> {!! $section10->file_client_name  ?? '' !!}</a>
                ...
                @foreach ( $file_more as $more )
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{!! HP::getFileStorage($attach_path.$more->file) !!}" target="_blank" class="view-attach btn btn-sm">{!! HP::FileExtension($more->file)  ?? '' !!} {!! $more->file_client_name  ?? '' !!}</a>
