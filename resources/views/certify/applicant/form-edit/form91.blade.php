<div id="viewForm91" class="{{$certi_lab->lab_type == 4 ? 'show':'hide'}}">
    ...
    <div class="form-group" style="margin-bottom: 10px;margin-left: 10px">
        <div class="col-md-6"> </div>
        <button type="button" class="btn btn-sm btn-success" id="attach-add62">
    ...
    <div id="other_attach-box62">
        <div class="form-group other_attach_item62">
            <div class="col-md-2">
                {!! Form::text('attachs_desc62[]', null, ['class' => 'form-control m-t-10', 'placeholder' => 'ชื่อไฟล์']) !!}
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-2 text-left m-t-15" style="margin-top: 3px">
                <button class="btn btn-danger btn-sm attach-remove62" type="button">
