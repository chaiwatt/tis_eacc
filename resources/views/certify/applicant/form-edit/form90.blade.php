...
<div id="viewForm90" class="{{$certi_lab->lab_type == 3 ? 'show':'hide'}}">
    ...
    <div class="form-group" style="margin-bottom: 10px;margin-left: 10px">
        ...
        <button type="button" class="btn btn-sm btn-success" id="attach-add61">
    ...
    <div id="other_attach-box61">
        <div class="form-group other_attach_item61">
            <div class="col-md-2">
                {!! Form::text('attachs_desc61[]', null, ['class' => 'form-control m-t-10', 'placeholder' => 'ชื่อไฟล์']) !!}
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-2 text-left m-t-15" style="margin-top: 3px">
                <button class="btn btn-danger btn-sm attach-remove61" type="button">
...
<script>
    ...
    function ShowHideRemoveBtn90() { //ซ่อน-แสดงปุ่มลบ
        ...
        if ($('.other_attach_item61').length > 1) {
