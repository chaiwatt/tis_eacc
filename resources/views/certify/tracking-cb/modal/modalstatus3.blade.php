                    ...
                    <div class="dropdown-menu" role="menu" >
                         @foreach($certi->tracking_payin_one_many as $key1 => $one)
                             @php 
                                 ...
                                 @endphp
                                 @if ($one->status  != 3) 
                                     <a  class="btn {{$payin1_btn}} " href="{{ url("certify/tracking-cb/tracking-pay_in1/".base64_encode($one->id))}}"  style="width:750px;text-align: left">
                               ...
                               @foreach($certi->tracking_save_assessment_many as $key2 => $assessment)
                                     @php 
                                        ...
                                        if ($assessment->bug_report == 1 ) { 
                                            $assessment_url = 'certify/tracking-cb/assessment/'.base64_encode($assessment->id);
                                        }else{
                                            $assessment_url = 'certify/tracking-cb/evaluation/'.base64_encode($assessment->id);
                                        }
                                      @endphp
