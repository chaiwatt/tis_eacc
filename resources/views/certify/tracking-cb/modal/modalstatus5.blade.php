...
{!! Form::open(['url' => 'certify/tracking-cb/inspection/update/'.$inspection->id,    'method' => 'POST', 'class' => 'form-horizontal  ','id'=>'form-inspection', 'files' => true]) !!}
...
<input type="hidden" name="previousUrl" id="previousUrl" value="{{ url('certify/tracking-cb') }}">
