...
@if(count($evaluation->history_ib_many) > 0)               
<div class="row">
    <div class="col-md-12">
...
<div id="collapse" class="panel-collapse collapse ">
    <br>
 <div class="container-fluid">
@foreach($evaluation->history_ib_many as $key1 => $item)
...
@if(count($evaluation->log_tracking_ib_assessment_bug_many) > 0) 
<div class="row">
    <div class="col-md-12">
        <div class="white-box" style="border: 2px solid #e5ebec;">
...
<div class="row">
 ...
 <div id="evaluation" class="panel-collapse collapse  in">
    <br> 
@foreach($evaluation->log_tracking_ib_assessment_bug_many as $key1 => $item1)
...
@endif
 ...
 {{-- {!! Form::open(['url' => 'certify/tracking-ib/evaluation/update/'.$evaluation->id,
