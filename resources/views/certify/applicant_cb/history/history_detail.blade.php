      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-left">
            ...
            @if( $history->system == 1 || $history->system == 2 || $history->system == 3)
                @include ('certify/applicant_cb/history.system01')
            @elseif( $history->system == 4)
               @include ('certify/applicant_cb/history.system04')
            @elseif( $history->system == 5)
               @include ('certify/applicant_cb/history.system05')
            @elseif( $history->system == 6)
               @include ('certify/applicant_cb/history.system06')
            @elseif( $history->system == 7)
                @include ('certify/applicant_cb/history.system07')
            @elseif( $history->system == 8)
                @include ('certify/applicant_cb/history.system08')
            @elseif( $history->system == 9)
                @include ('certify/applicant_cb/history.system09')
