                    ...
                    <div class="table-responsive">
                        <table class="table table">
                            <tbody>
                              ...
                              <tr><th> Applicant 21own Id </th><td> {{ $volume_21bi->applicant_21own_id }} </td></tr><tr><th> Start Date </th><td> {{ $volume_21bi->start_date }} </td></tr><tr><th> End Date </th><td> {{ $volume_21bi->end_date }} </td></tr><tr><th> Attach </th><td> {{ $volume_21bi->attach }} </td></tr><tr><th> Inform Close </th><td> {{ $volume_21bi->inform_close }} </td></tr>
                              <tr>
                                <th> สถานะ </th>
