...
<table class="table color-bordered-table primary-bordered-table">
    ...
    @foreach ($product_details as $key => $item)
        <tr>
            ...
            <td class="text-center align-top">
                {!! Form::number('quantity_detail[]', !empty($item->quantity)?$item->quantity:null, ['class' => 'form-control text-left', 'step' => '0.01', 'max' => '9999999999.99']) !!}
            </td>
            <td class="text-center align-top">
...
<div class="form-group {{ $errors->has('country_export') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::select('country_export[]',
            App\Models\Basic\Country::pluck('title', 'id')->all(),
            null,
        ['class' => 'select2 select2-multiple', 'required' => 'required', 'multiple'=>'multiple', 'data-placeholder'=>'- เลือกประเทศ -']) !!}
                ...
                <div class="col-md-8">
                    <div class="fileinput fileinput-new input-group pull-left col-md-8" data-provides="fileinput">
                        ...
                        <span class="input-group-addon btn btn-default btn-file">
                            <span class="fileinput-new">เลือกไฟล์</span>
                            <span class="fileinput-exists">เปลี่ยน</span>
                            {!! Form::file('attach_difference_standard', ['required' => true,'class'=>'check_max_size_file']) !!}
                          </span>
                        <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">ลบ</a>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        <div class="fileinput fileinput-new input-group pull-left col-md-10" data-provides="fileinput">
                            ...
                            <span class="input-group-addon btn btn-default btn-file">
                              <span class="fileinput-new">เลือกไฟล์</span>
                              <span class="fileinput-exists">เปลี่ยน</span>
                              {{-- {!! Form::file('attach_other[]', null, ['required' => false,'class'=>'check_max_size_file']) !!} --}}
...
<div class="row">
    <div class="white-box center">
        <fieldset>
            ...
            <p class="p_condition">
                ประกาศคณะกรรมการมาตรฐานผลิตภัณฑ์อุตสาหกรรม เรื่อง หลักเกณฑ์และเงื่อนไขในการทำ<br>
                ผลิตภัณฑ์อุตสาหกรรมที่แตกต่างไปจากมาตรฐานที่กำหนดเพื่อประโยชน์ในการส่งออก พ.ศ. 2562<br>
                ประกาศ ณ วันที่ 19 กันยายน พ.ศ. 2562</p>
            <p class="p_condition_detail">
                1. ต้องทำผลิตภัณฑ์อุตสาหกรรมตามมาตรฐานที่ใช้อ้างอิงในการทำ หรือข้อกำหนดของลูกค้าในต่างประเทศ<br>
                โดยมีระยะเวลา และจำนวนหรือปริมาณ ไม่เกินกว่าที่ได้แจ้งไว้ต่อสำนักงานมาตรฐานผลิตภัณฑ์อุตสาหกรรม

            </p>
            <p class="p_condition_detail">
            2. ต้องแสดงข้อความ "เพื่อส่งออกเท่านั้น" หรือ "EXPORT ONLY" หรือข้อความที่มีความหมายในลักษณะเดียวกัน<br>
            ให้เห็นได้ง่ายและชัดเจน ไว้ที่ผลิตภัณฑ์อุตสาหกรรม หรือบนสิ่งบรรจุ หีบห่อ สิ่งห่อหุ้ม หรือสิ่งผูกมัด ก่อนนำออกจากสถานที่ผลิต
            </p>
            <p class="p_condition_detail">
            3. ต้องแยกเก็บผลิตภัณฑ์อุตสาหกรรมตามข้อ 1 มิให้ปะปนกับผลิตภัณฑ์อุตสาหกรรมที่ได้รับใบอนุญาต<br>
            หรือการอนุญาตอื่นที่ออกโดยสำนักงานมาตรฐานผลิตภัณฑ์อุตสาหกรรม

            </p>
            <p class="p_condition_detail">
            4. ผลิตภัณฑ์อุตสาหกรรมตามข้อ 1 ต้องส่งออกไปต่างประเทศ ตามที่แจ้งไว้เท่านั้น และให้ผู้แจ้งรายงานปริมาณการผลิต <br>
            รายงานปริมาณการส่งออก และรายงานปริมาณคงเหลือของผลิตภัณฑ์อุตสาหกรรมที่ได้แจ้งภายหลังการส่งออก <br>
            พร้อมส่งสำเนาเอกสารหลักฐานใบขนสินค้าขาออกซึ่งต้องระบุจำนวนผลิตภัณฑ์อุตสาหกรรมที่ส่งออกให้สำนักงานมาตรฐานผลิตภัณฑ์อุตสาหกรรมทราบ<br>
            ภายในสิบห้าวันนับแต่วันที่ส่งออก

            </p>
            <p class="p_condition" style="margin-top: 40px">
            ทั้งนี้ การไม่ปฏิบัติตามหลักเกณฑ์และเงื่อนไขข้างต้น อาจถูกสั่งเพิกถอนใบรับแจ้งตามมาตรา 20 ตรี <br>
            และต้องระวางโทษจำคุกไม่เกินสองปี หรือปรับไม่เกินสองล้านบาท หรือทั้งจำทั้งปรับ ตามมาตรา 39 ตรี<br>
            และมาตรา 48 ทวิ แห่งพระราชบัญญัติมาตรฐานผลิตภัณฑ์อุตสาหกรรม พ.ศ. 2511 และที่แก้ไขเพิ่มเติม
            </p>
...
@if(isset($applicant_20ter) && $applicant_20ter->state=='3')
<div class="row">
    <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {{ HP::StateApplicants()[$applicant_20ter->state] }} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {!! nl2br($applicant_20ter->remake_officer_export) !!} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {!! App\Models\Basic\Staff::find($applicant_20ter->officer_export)->FullName !!} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
