...
@if(isset($applicant21bi) && $applicant21bi->state=='3')
<div class="row">
    <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {{ HP::StateApplicants()[$applicant21bi->state] }} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {!! nl2br($applicant21bi->remake_officer_export) !!} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {!! App\Models\Basic\Staff::find($applicant21bi->officer_export)->FullName !!} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('inform_calibrate'))
            <a class="btn btn-default" href="{{url('/esurv/applicant_21bis')}}">
