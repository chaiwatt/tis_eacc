...
<div class="form-group">
  {!! Html::decode(Form::label('attach', 'ไฟล์แนบ (ถ้ามี):<br><span class="text-muted">รองรับไฟล์ .pdf และ .jpg ขนาดไม่เกิน '. ini_get('upload_max_filesize').'B</span>', ['class' => 'col-md-4 control-label'])) !!}
  <div class="col-md-8">
...
<div id="other_attach_box">
  ...
  <div class="form-group other_attach_item">
    ...
    <div class="col-md-2">
      ...
      <button class="btn btn-danger btn-sm attach-remove button_hide" type="button">
...
<div class="form-group list_attach{{ $errors->has('state') ? 'has-error' : ''}}">
...
<div class="form-group">
  <div class="col-md-offset-4 col-md-4">
    ...
    <a class="btn btn-default list_attach" href="{{url('/esurv/tisi_license_notification')}}">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('#attach-add').click(function(event) {
      $('.other_attach_item:first').clone().appendTo('#other_attach_box');
