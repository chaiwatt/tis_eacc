...
<div class="form-group {{ $errors->has('calibration_date') ? 'has-error' : ''}}">
    {!! Form::label('calibration_date', 'วันที่ทำการทำสอบเทียบ', ['class' => 'col-md-4 control-label required']) !!}
    <div class="col-md-6">
        {!! Form::text('calibration_date', null, ['class' => 'form-control mydatepicker', 'required' => 'required']) !!}
        {!! $errors->first('calibration_date', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
<div id="other_attach-box">
  ...
  <div class="form-group other_attach_item">
    ...
    <div class="col-md-2">
      ...
      @if (is_file(public_path().'/esurv_attach/inform_calibration/'.$attach->file_name))
      <a href="{{ asset('esurv_attach/inform_calibration/'.$attach->file_name) }}" target="_blank" class="view-attach btn btn-info btn-sm"><i class="fa fa-search"></i></a>
      @endif
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('inform_calibration'))
            <a class="btn btn-default" href="{{url('/esurv/inform_calibration')}}">
