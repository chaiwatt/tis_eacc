    ...
    <tbody id="table-body">
      ...
      @foreach ($product_details as $key => $item)
          <tr>
              ...
              <td class="text-center align-top">
                  {!! Form::number('quantity_detail[]', $item->quantity, ['class' => 'form-control', 'step'=>'0.01', 'max'=>'9999999999.99']) !!}
              </td>
              <td class="text-center align-top">
...
@if(isset($applicant20bi) && $applicant20bi->state=='3')
<div class="row">
    <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {{ HP::StateApplicants()[$applicant20bi->state] }} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {!! nl2br($applicant20bi->remake_officer_export) !!} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static"> {!! App\Models\Basic\Staff::find($applicant20bi->officer_export)->FullName !!} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('inform_calibrate'))
            <a class="btn btn-default" href="{{url('/esurv/applicant_20bis')}}">
