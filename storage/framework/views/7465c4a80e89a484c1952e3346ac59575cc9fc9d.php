...
<div style="display: none;">
    <?php echo $__env->make('certify.applicant.forms.form_infomation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
<?php echo $__env->make('certify.applicant.forms.form_request', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('certify.applicant.forms.form_model', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('certify.applicant.forms.form_evidence', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php if( isset($certi_lab->desc_delete) && isset($certi_lab->id) && !is_null($certi_lab->desc_delete)): ?>
...
<fieldset class="white-box">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6 text-light">
            <p> <?php echo e(!empty($certi_lab->desc_delete)  ? $certi_lab->desc_delete : '-'); ?></p>
        </div>
    </div>

    <div class="clearfix"></div>

    <?php if(isset($certi_lab->id) && $CertiLabDeleteFile->count() > 0): ?>
        <div class="row">
                ...
                <?php if($data->path): ?>
                    <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-6 text-light">
                            ...
                            <a href="<?php echo e(url('certify/check/files/'.$data->path)); ?>" target="_blank">
        ...
        <div class="col-md-12">
            <div class="checkbox checkbox-success">
                <input id="checkbox_confirm" class="checkbox_confirm" type="checkbox" name="checkbox_confirm"  required value="1" 
                    <?php echo e((isset($certi_lab->id) && $certi_lab->checkbox_confirm  == 1) ? 'checked': ''); ?>
