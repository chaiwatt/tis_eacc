...
<body>
   <div id="style">
    ...
    <p> 
        <b>เรื่อง ลงนามยืนยันขอบข่าย</b>    
    </p>

    <p class="indent50"> 
        ขอแจ้งเพื่อให้ท่านกรุณาลงนามลงนามยืนยันขอบข่าย โดยเข้าระบบ <a href="<?php echo e($url ?? '/'); ?>"class="btn btn-link" target="_blank">E-Accreditation</a>
    </p>
