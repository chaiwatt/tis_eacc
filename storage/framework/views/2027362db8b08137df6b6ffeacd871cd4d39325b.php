    ...
    <div class="lab-header">
        <div class="main">
            <div class="inline-block  w-100 text-center float-left" >
                ...
                <span class="cer_no" style="line-height: 5px !important;"><strong>ใบรับรองเลขที่ <?php echo e($pdfData->certificate_no); ?></strong> 

                </span>
                <br>
                    <span class="cer_no_en">(Certification no. <?php echo e($pdfData->certificate_no); ?>)</span>
        ...
        <div class="info" style="margin-top: 7px">
            ...
            <div class="inline-block w-78 float-left"><?php echo e($company->app_certi_lab->lab_name); ?> <br> <span>(<?php echo e($company->app_certi_lab->lab_name_en); ?>)</span></div>
        </div>
    
        <div class="info">
            <div class="inline-block w-20 float-left" style="margin-top:7px">หมายเลขการรับรองที่<br> <span>(Accreditation No.)</span> </div>
            <div class="inline-block w-78">สอบเทียบ <?php echo e($pdfData->acc_no); ?><br> <span>(Calibration <?php echo e($pdfData->acc_no); ?>)</span></div>
        </div>
    
        <div class="info">
            <div class="inline-block w-20 float-left" style="margin-top:7px">ฉบับที่ <?php echo e($pdfData->book_no); ?><br> <span>(Issue No. <?php echo e($pdfData->book_no); ?>)</span></div>
            <div class="inline-block w-78">
                <div class="inline-block w-55 float-left">
                    ออกให้ตั้งแต่วันที่ <?php echo e($pdfData->from_date_th); ?><br> <span style="padding-left:20px">(Valid from) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<?php echo e($pdfData->from_date_en); ?>)</span>
                </div>
                <div class="inline-block w-40 float-right">
                    ถึงวันที่ <?php echo e($pdfData->to_date_th); ?><br> <span>(Until) (<?php echo e($pdfData->to_date_en); ?>)</span>
                </div>
            </div>
        </div>
            ...
            <div class="inline-block w-78">
                <div class="inline-block w-17 float-left">
                    <?php if($company->id == 1): ?>
                        ...
                        <input type="checkbox" <?php echo e(in_array("pl_2_1_main", $pdfData->uniqueKeys) ? 'checked="checked"' : ''); ?>>ถาวร<br> <span>(Permanent)</span>
                    <?php else: ?>
                        <!-- ตรวจสอบว่า uniqueKeys มี "pl_2_1_branch" หรือไม่ -->
                        <input type="checkbox" <?php echo e(in_array("pl_2_1_branch", $pdfData->uniqueKeys) ? 'checked="checked"' : ''); ?>>ถาวร<br> <span>(Permanent)</span>
                    <?php endif; ?>
                </div>
                <div class="inline-block w-20 float-left">
                    <?php if($company->id == 1): ?>
                        <!-- ตรวจสอบว่า uniqueKeys มี "pl_2_1_main" หรือไม่ -->
                        <input type="checkbox" <?php echo e(in_array("pl_2_2_main", $pdfData->uniqueKeys) ? 'checked="checked"' : ''); ?>>นอกสถานที่<br> <span>(Site)</span>
                    <?php else: ?>
                        <!-- ตรวจสอบว่า uniqueKeys มี "pl_2_1_branch" หรือไม่ -->
                        <input type="checkbox" <?php echo e(in_array("pl_2_2_branch", $pdfData->uniqueKeys) ? 'checked="checked"' : ''); ?>>นอกสถานที่<br> <span>(Site)</span>
                    <?php endif; ?>
                </div>
                <div class="inline-block w-20 float-left">
                    <?php if($company->id == 1): ?>
                        <!-- ตรวจสอบว่า uniqueKeys มี "pl_2_1_main" หรือไม่ -->
                        <input type="checkbox" <?php echo e(in_array("pl_2_3_main", $pdfData->uniqueKeys) ? 'checked="checked"' : ''); ?>>ชั่วคราว<br> <span>(Temporary)</span>
                    <?php else: ?>
                        <!-- ตรวจสอบว่า uniqueKeys มี "pl_2_1_branch" หรือไม่ -->
                        <input type="checkbox" <?php echo e(in_array("pl_2_3_branch", $pdfData->uniqueKeys) ? 'checked="checked"' : ''); ?>>ชั่วคราว<br> <span>(Temporary)</span>
                    <?php endif; ?>
                </div>
                <div class="inline-block w-20 float-left">
                    <?php if($company->id == 1): ?>
                        <!-- ตรวจสอบว่า uniqueKeys มี "pl_2_1_main" หรือไม่ -->
                        <input type="checkbox" <?php echo e(in_array("pl_2_4_main", $pdfData->uniqueKeys) ? 'checked="checked"' : ''); ?>>เคลื่อนที่<br> <span>(Mobile)</span>
                    <?php else: ?>
                        <!-- ตรวจสอบว่า uniqueKeys มี "pl_2_1_branch" หรือไม่ -->
                        <input type="checkbox" <?php echo e(in_array("pl_2_4_branch", $pdfData->uniqueKeys) ? 'checked="checked"' : ''); ?>>เคลื่อนที่<br> <span>(Mobile)</span>
                    <?php endif; ?>
                </div>
                <div class="inline-block w-17 float-left">
                    <input type="checkbox" <?php echo e($pdfData->siteType == "multi" ? 'checked="checked"' : ''); ?> >หลายสถานที่<br> <span>(Multisite)</span>
                </div>
            </div>
        </div>
    </div>
