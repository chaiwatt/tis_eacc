...
<?php if($certi_cb == null || empty($certi_cb->doc_review_reject)): ?>
    <?php echo $__env->make('certify.applicant_cb.froms.scope-modal.cb_scope_isic_isic', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('certify.applicant_cb.froms.scope-modal.cb_scope_bcms', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->make('certify.applicant_cb/froms.form_infomation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('certify.applicant_cb/froms.form_request', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>
...
<?php echo $__env->make('certify.applicant_cb/froms.form_modal_map', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php echo $__env->make('certify.applicant_cb/froms.form_evidence', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php if(isset($certi_cb->id) && !is_null($certi_cb->desc_delete)): ?>
...
<fieldset class="white-box">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6 text-light">
            <p> <?php echo e(!empty($certi_cb->desc_delete)  ? $certi_cb->desc_delete : '-'); ?></p>
        </div>
    </div>

    <div class="clearfix"></div>

    <?php if(isset($certi_cb->id) && $certi_cb->FileAttach5->count() > 0): ?>
        <div class="row">
            <?php $__currentLoopData = $certi_cb->FileAttach5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($data->file): ?>
                    <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-6 text-light">
                            ...
                            <a href="<?php echo e(url('certify/check/file_cb_client/'.$data->file.'/'.( !empty($data->file_client_name) ? $data->file_client_name :  basename($data->file)  ))); ?>" target="_blank">
    ...
    <div class="row form-group">
        <div class="col-md-12">
            <div class="checkbox checkbox-success">
                <input id="checkbox_confirm" class="checkbox_confirm" type="checkbox" name="checkbox_confirm"  required  value="1"  <?php echo e((isset($certi_cb->id) && $certi_cb->checkbox_confirm  == 1) ? 'checked': ''); ?>>
...
<?php $__env->startPush('js'); ?>
    ...
    <script src="<?php echo e(asset('plugins/components/repeater/jquery.repeater.min.js')); ?>"></script>
...
let selectedModel = null;
        ...
        function submit_form(status) {
            ...
            var  number =  1;
            var max_size = "<?php echo e(ini_get('post_max_size')); ?>";
