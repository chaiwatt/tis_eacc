...
<head>
    ...
    <!-- ===== Bootstrap CSS ===== -->
    <link href="<?php echo e(asset('bootstrap/dist/css/bootstrap.min.css?v=').str_random()); ?>" rel="stylesheet">
    <!-- ===== Plugin CSS ===== -->
    ...
    ?>
                <?php echo $__env->make('users.industry', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php
            }
        }
    }
    ...
    <link href="<?php echo e(asset('css/colors/'.$theme_name.'.css')); ?>" id="theme" rel="stylesheet">

    <?php elseif($theme_layout == 'mini-sidebar'): ?>
    ...
    <link href="<?php echo e(asset('plugins/components/bootstrap-iconpicker/bootstrap-iconpicker.min.css')); ?>" rel="stylesheet">
...
<body class="
  <?php echo e($theme_layout); ?>

  <?php if($fix_header===true): ?> fix-header <?php endif; ?>
  <?php if($fix_sidebar===true): ?> fix-sidebar <?php endif; ?>">
    <!-- ===== Main-Wrapper ===== -->
    <div id="wrapper">
        <div class="preloader">
        ...
        <?php echo $__env->make('layouts.partials.right-sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <!-- ===== ICON JS ===== -->
    <script src="<?php echo e(asset('plugins/components/bootstrap-iconpicker/bootstrap-iconpicker-iconset-all.min.js')); ?>"></script>
    <script src="<?php echo e(asset('plugins/components/bootstrap-iconpicker/bootstrap-iconpicker.min.js')); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        function check_max_size_file() {
            var max_size = "<?php echo e(ini_get('upload_max_filesize')); ?>";
