<fieldset class="white-box">
    <legend>
        <h4><span class="text-danger">*</span> 1. คู่มือคุณภาพและขั้นตอนการดำเนินงานของ<span id="span_certification"><?php echo e(!empty($certi_cb->CertiCBFormulasTo->title) ? $certi_cb->CertiCBFormulasTo->title : 'หน่วยรับรอง'); ?></span>ที่สอดคล้องตามข้อกำหนดมาตรฐานที่ มอก.
            <span class="span_tis"><?php echo e(!empty($certi_cb->FormulaTo->title) ?   str_replace("มอก.","",$certi_cb->FormulaTo->title)  : null); ?></span> 
    ...
    <div class="row repeater-form-file">
        <div class="col-md-12 box_section1" data-repeater-list="repeater-section1" >
            ...
            <?php if( isset( $certi_cb->id ) && count( App\Models\Certify\ApplicantCB\CertiCBAttachAll::where('app_certi_cb_id', $certi_cb->id )->where('file_section', '1')->get() ) > 0 ): ?>
                ...
                <?php $__currentLoopData = $file_sectionn1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-group">
                        <div class="col-md-4 text-light"></div>
                        <div class="col-md-6">
                            <a href="<?php echo HP::getFileStorage($attach_path.$section1->file); ?>" target="_blank" class="view-attach"><?php echo HP::FileExtension($section1->file_client_name)  ?? ''; ?> <?php echo $section1->file_client_name  ?? ''; ?></a>
                            <a href="<?php echo e(url('certify/applicant-cb/delete/file_app_certi_cb_attach_all').'/'.$section1->id.'/'.$certi_cb->token); ?>" class="btn btn-danger btn-xs box_remove_file" onclick="return confirm('ต้องการลบไฟล์นี้ใช่หรือไม่ ?')">
                ...
                <div class="col-md-6">
                    <div class="fileinput fileinput-new input-group " data-provides="fileinput">
                        ...
                        <span class="input-group-addon btn btn-default btn-file">
                            ...
                            <input type="file" name="attachs_sec1" class="attachs_sec1 check_max_size_file" <?php echo $section1_required; ?>>
                        </span> 
                        <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">ลบ</a>
                    </div>
                    <?php echo $errors->first('attachs_sec1', '<p class="help-block">:message</p>'); ?>
...
<fieldset class="white-box">
    ...
    <div class="row repeater-form-file">
        <div class="col-md-12 box_section2" data-repeater-list="repeater-section2" >
            ...
            <?php if( isset( $certi_cb->id ) && count( App\Models\Certify\ApplicantCB\CertiCBAttachAll::where('app_certi_cb_id', $certi_cb->id )->where('file_section', '2')->get() ) > 0 ): ?>
                ...
                <?php $__currentLoopData = $file_sectionn2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-group">
                        <div class="col-md-4 text-light"></div>
                        <div class="col-md-6">
                            <a href="<?php echo HP::getFileStorage($attach_path.$section2->file); ?>" target="_blank" class="view-attach"> <?php echo HP::FileExtension($section2->file_client_name)  ?? ''; ?> <?php echo $section2->file_client_name  ?? ''; ?></a>
                            <a href="<?php echo e(url('certify/applicant-cb/delete/file_app_certi_cb_attach_all').'/'.$section2->id.'/'.$certi_cb->token); ?>" class="btn btn-danger btn-xs box_remove_file" onclick="return confirm('ต้องการลบไฟล์นี้ใช่หรือไม่ ?')">
                                <i class="fa fa-remove"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="form-group box_remove_file" data-repeater-item>
                ...
                <div class="col-md-6">
                    ...
                    <?php echo $errors->first('attachs_sec2', '<p class="help-block">:message</p>'); ?>
...
<button type="button" class="btn btn-info" id="button_load_bcms">Load Bcms scope</button>
    ...
    <?php if($certi_cb == null || empty($certi_cb->doc_review_reject)): ?>
        <fieldset class="white-box">
            <legend>
                <h4>
...
<fieldset class="white-box">
    ...
    <div class="row repeater-form-file">
        <div class="col-md-12 box_section5" data-repeater-list="repeater-section5" >
            ...
            <?php if( isset( $certi_cb->id ) && count( App\Models\Certify\ApplicantCB\CertiCBAttachAll::where('app_certi_cb_id', $certi_cb->id )->where('file_section', '5')->get() ) > 0 ): ?>
                ...
                <?php $__currentLoopData = $file_sectionn5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section5): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-group">
                        <div class="col-md-4 text-light"></div>
                        <div class="col-md-6">
                            <a href="<?php echo HP::getFileStorage($attach_path.$section5->file); ?>" target="_blank" class="view-attach"> <?php echo HP::FileExtension($section5->file_client_name)  ?? ''; ?> <?php echo $section5->file_client_name  ?? ''; ?></a>
                            <a href="<?php echo e(url('certify/applicant-cb/delete/file_app_certi_cb_attach_all').'/'.$section5->id.'/'.$certi_cb->token); ?>" class="btn btn-danger btn-xs box_remove_file" onclick="return confirm('ต้องการลบไฟล์นี้ใช่หรือไม่ ?')">
                                <i class="fa fa-remove"></i>
                            </a>
                        </div>
                    </div>
...
<fieldset class="white-box">
    ...
    <div class="row repeater-form-file">
        <div class="col-md-12 box_section_other" data-repeater-list="repeater-section4" >
            ...
            <?php if( isset( $certi_cb->id ) && count( App\Models\Certify\ApplicantCB\CertiCBAttachAll::where('app_certi_cb_id', $certi_cb->id )->where('file_section', '4')->get() ) > 0 ): ?>
                ...
                <?php $__currentLoopData = $file_sectionn4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-group">
                        <div class="col-md-4 text-light"><input type="text" class='form-control' value="<?php echo !empty( $section4->file_desc )?$section4->file_desc:null; ?>" disabled></div>
                        <div class="col-md-6">
                            <a href="<?php echo HP::getFileStorage($attach_path.$section4->file); ?>" target="_blank" class="view-attach"> <?php echo HP::FileExtension($section4->file_client_name)  ?? ''; ?> <?php echo $section4->file_client_name  ?? ''; ?></a>
                            <a href="<?php echo e(url('certify/applicant-cb/delete/file_app_certi_cb_attach_all').'/'.$section4->id.'/'.$certi_cb->token); ?>" class="btn btn-danger btn-xs box_remove_file" onclick="return confirm('ต้องการลบไฟล์นี้ใช่หรือไม่ ?')">
                                <i class="fa fa-remove"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="form-group box_remove_file" data-repeater-item>
                <div class="col-md-4 text-light">
                    <?php echo Form::text('attachs_txt', null, ['class' => 'form-control', 'placeholder' => 'กรุณากรอกชื่อไฟล์']); ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        $(document).ready(function () {
            ...
            certificationBranch = <?php echo json_encode($certificationBranch ?? [], 15, 512) ?>;
        ...
        function  deleteFlie(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?php echo url('certify/certi_cb/delete_file'); ?>"  + "/" + id
        ...
        function addCbScopeIsicModel()
        {
            ...
            console.log(selectedModel,_token)
                ...
                $.ajax({
                url: "<?php echo e(route('applicant_cb.get_cb_isic_scope')); ?>",
                method: "POST",
                data: {
        ...
        function addCbScopeBcmsModel()
        {
            ...
            $.ajax({
                url: "<?php echo e(route('applicant_cb.get_cb_bcms_scope')); ?>",
                method: "POST",
                data: {
                    selectedModel: selectedModel,
                    _token: _token
        ...
        $('#button_store_cb_scope_isic_isic').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('applicant_cb.demo_store_cb_isic_scope')); ?>",
                method: "POST",
        ...
        function loadCbScopeIsic()
        {
            ...
            // return;
            $.ajax({
                url: "<?php echo e(route('applicant_cb.get_cb_isic_scope_transaction')); ?>",
                method: "POST",
                data: {
                    cbId: cbId,
                    _token: _token
        ...
        $('#button_store_cb_scope_bcms').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('applicant_cb.demo_store_cb_bcms_scope')); ?>",
                method: "POST",
                contentType: 'application/json',
                headers: {
                    'X-CSRF-TOKEN': _token
        ...
        function loadCbScopeBcms()
        {
            ...
            $.ajax({
                url: "<?php echo e(route('applicant_cb.get_cb_bcms_scope_transaction')); ?>",
                method: "POST",
                data: {
                    cbId: cbId,
                    _token: _token
