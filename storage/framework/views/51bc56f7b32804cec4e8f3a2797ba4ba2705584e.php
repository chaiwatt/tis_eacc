...
<div class="modal fade actionSeven"  tabindex="-1" role="dialog" aria-labelledby="addBrand">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?php echo Form::open(['url' => 'certify/applicant/update/status/to/eight', 'class' => 'form-horizontal','id'=>'app_certi_form', 'files' => true]); ?>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class=" form-group <?php echo e($errors->has('activity_file') ? 'has-error' : ''); ?>">
                            ...
                            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                ...
                                <span class="input-group-addon btn btn-default btn-file">
                                    ...
                                    <span class="fileinput-exists">เปลี่ยน</span>
                                        <?php echo Form::file('activity_file', null); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $('.btn7').on('click',function () {
            ...
            var path = '<?php echo e(url('certify/check/files/')); ?>' + "/" + baseName($(this).attr('data-payment'));
