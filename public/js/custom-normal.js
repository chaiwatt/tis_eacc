$(function() {
    ...
    $(function() {
        ...
        var element = $('ul#side-menu a').filter(function() {
            ...
            var array = String(this.href).split("/");
            var last_str = array[array.length-1];

            return String(url).search(last_str)!=-1?true:false;
    ...
    $(".right-side-toggler").on('click', function() {
        ...
        $(".fxhdr").on('click', function() {
            ...
            $.get(url + '/admin/users/savefix-header/' + $(this).prop('checked'), function(data) {
                //console.log('success');
            });
        ...
        $(".fxsdr").on('click', function() {
            ...
            $.get(url + '/admin/users/savefix-sidebar/' + $(this).prop('checked'), function(data) {
                //console.log('success');
            });
